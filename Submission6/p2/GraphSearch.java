...
/**
 * Klassen innehåller sökning metoder
 * 
...
public class GraphSearch {
	...
	/***************************
	 * DEPTH FIRST TRAVERSAL ********************** Traverserar grafen genom
	 * sökning på djupet. Noderna returneras som en Iterator-implementering
	 * 
	 * @param graph
	 *            grafen som traverseras
	 * @param from
	 *            nod i vilken travereringen startar
	...
	/***************************
	 * DEPTH FIRST SEARCH ************************* Sökning av väg från
	 * <code>from</code> till <code>to</code> sker på djupet. Den först funna
	 * vägen returneras.<br>
	 * Om <code>from</code> ej finns i grafen kastas NullPoinerException.
	 * 
	 * @param from
	 *            Nod där sökningen startar
	 * @param to
	 *            Nod där sökningen slutar
	...
	/***************************
	 * BREADTH FIRST SEARCH ************************* Sökning av väg från
	 * <code>from</code> till <code>to</code> sker på bredden. Den först funna
	 * vägen returneras.<br>
	 * Om <code>from</code> ej finns i grafen kastas NullPoinerException.
	 * 
	 * @param from
	...
	/**
	 * Sökning av väg från <code>from</code> till <code>to</code> sker på
	 * bredden. Vägen med lägst vikt returneras.<br>
	 * Om <code>from</code> ej finns i grafen kastas NullPoinerException.
	 * 
	 * @param from
	 *            Nod där sökningen startar
	 ...
	 *         <code>to</code>. Går det inte att komma till <code>to</code>
